...
export default class Search {
  ...
  renderResultsHTML(posts) {
    if (posts.length) {
        ...
        this.resultsArea.innerHTML = `<p class="alert alert-danger text-center shadow-sm">No results</p>`
    }
    this.hideLoaderIcon()
  ...
  injectHTML() {
    ...
    <div class="search-overlay-top shadow-sm">
      <div class="container container--narrow">
        ...
        <input type="text" id="live-search-field" class="live-search-field" placeholder="Search Building">
